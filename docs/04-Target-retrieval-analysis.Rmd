...
Before manually browsing individual databases, it is worth noting that `TCMDATA` provides two convenient functions for **programmatic** disease–gene association retrieval, powered by the [DisGeNET](https://www.disgenet.org/) dataset bundled in the [`DOSE`](https://bioconductor.org/packages/DOSE/) Bioconductor package. This approach allows you to query disease targets directly from R without visiting any web interface.
