...
```{r pubmed-plots, fig.width=10, fig.height=8, fig.align='center', out.width='95%'}
library(aplot)
...
`TCMDATA` includes `dn_targets`, a character vector of Diabetic Nephropathy (DN)-associated genes sourced from GeneCards. We use these as the query gene set to identify enriched herbs.
